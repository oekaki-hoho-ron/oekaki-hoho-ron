...
「理解と記憶」よりもっと根元の「認識」レベルでカテゴライズするには、<bb>「絵」という視点から一旦離れて、もっと原始的な認識レベルまで分解する</bb>必要があります。<gg>原理体系の根本付近を正しくカテゴライズできれば、それに続く末端の概念もおのずと正しく整理されていく</gg>ことになります。人の認識のメカニズムに最適化されたカテゴリーを枠組みとすることで観察対象の情報をすみずみまで精査できるようになり、気を抜いて情報を拾い忘れるということを回避できます。そのことの何が嬉しいかと言うと、獲得した情報を適切に知識体系に組み込めることは当然ですが、なにより意図的に情報を拾えるようになるため<yy>数をこなす練習</yy>をせずに済む可能性が高いです。絵の練習の根元にある「認識」を適切に行うことで最小限の練習量で多くの情報を獲得し、練習で獲得した知識が何であるかを正しく「理解」して記銘することで「記憶」し、さらに必要な記憶を効率的に「想起」する、という流れを実現することが目標です。そのために、人の認識のパターンを論理学的に精査した哲学者<oo>カント</oo>の『<oo>純粋理性批判</oo>』を応用します。
...
## 第3節　『純粋理性批判』の悟性におけるカテゴライズとは■■■■■■■■■■■■未完成

『純粋理性批判』の悟性におけるカテゴリーとは、物事を認識するときの論理的な体系のことです。一方で『お絵描きのメカニズム』におけるカテゴリーとは、記憶や知識の体系です。つまり、前者は認識について、後者は記憶についての論理構造を示すもので、2つの「カテゴリー」には順序的な関係があることになります。認識したものを記憶するので、『純粋理性批判』におけるカテゴリーとは、『お絵描きのメカニズム』における<yy>言語化フィルタ</yy>と同義ということになります。よって、これまで純粋理性批判のカテゴリーを参考にすると散々言ってきましたが、お絵描きのメカニズムのカテゴリーは独自に考えた方が適切だという結論に至りました。いずれにせよ、2つのカテゴリーはお絵描きのメカニズムにとって重要な機能を持っているため、身長に組み込む必要があります。とりあえずここでは、お絵描きのメカニズムのカテゴリーをどう扱うかという方針を決める程度の話にとどめておこうと思います。というわけで、純粋理性批判の考え方を導入するのは後回しにして、お絵描きのメカニズムの原理スロットのカテゴライズについて説明していきます。

お絵描きのメカニズムのカテゴリー、つまり上達サイクルで行うカテゴライズの体系は、以前Twitterで考察した独自のアイデアを元に構築してみようと思います。以前、人体素体のデザインを模索しているときの考察を総括して、人体デッサンの記号を「<yy>素体</yy>」「<yy>素材</yy>」「<yy>印象</yy>」「<yy>添削</yy>」の4つの機能に分類しました。

1つ目の<yy>素体</yy>とは、<bb>デッサンする形状の基礎となる単純形状の記号のこと</bb>で、丁度3DCGソフトにプリインストールされている立方体、球体、円柱、円錐などの基本形状と同じ機能をもつものです。人体デッサンでは、<bb>作風に合うプロポーションを事前に組み込んでおくデッサン人形</bb>のように使います。<gg>素体は、複雑形状の被写体をデッサンするときにその立体感を捉えやすいようできる限り情報量を削減しておくことで、大まかなシルエットで画面内に配置したり、遠近感を出すためにパースに乗せたりという作業に集中できます</gg>。特に全ての素体を立方体ベースで作っておくことで、パースに乗せたときの奥行きの長さを正確に測定することができ、精密な遠近感が必要とされる絵を描くときに活用できます。素体のデザインは、各々が自分に必要な形状セットを用意しておくことが好ましく、普段の練習は素体デザインをすることが目的の一つとなっています。まずは[湯浅誠](){}さんが考案された「立方体の九九」を練習してみてはいかがでしょうか。単純形状の素体を使う、という感覚を体感した後で、どのような形状や補助線があればデッサンの助けになるかということを自分なりに試行錯誤してみるといいでしょう。素体デザインは「箱型」と「流線型」がある。

2つ目の<yy>素材</yy>とは、<bb>素体の上に取り付けていくディテールの記号のこと</bb>で、髪の毛の束、服のシワ、目や耳の形などといった、<bb>その都度異なる形状で描かなくてはならない部分</bb>です。<bb>素体は一度デザインすれば使い回しできます</bb>が、<bb>素材はキャラクターやポーズによって変化するため使い回しは難しい</bb>です。そのため、素材を描き加えるには資料を観察して材料を集めながらデッサンする必要があります。このことから、素体と素材のあり方を一言で表すと「<yy>素体プリセット</yy>」と「<yy>素材モンタージュ</yy>」となります。<bb>素体は事前に用意しておくプリセットのようなもので、それをベースに素材を貼り付け（モンタージュ）していく</bb>という具合です。また、<bb>素材も使い込んで慣れてしまえば素体と同等の扱いができるようになります</bb>。・・・違う。上乗せするパーツのことを素材ということにしたいが、どちらかといえば素体＝遠近感、素材＝立体感として扱いたい。

3つ目の<yy>印象</yy>は、髪型のシルエット、目や耳の形状、服のシワなど。

4つ目の<yy>添削</yy>は、測定、微調整。

|種類|説明|用途|例|
|:-:|---|:-:|:-:|
|箱型素体|印象抽出による大まかな画面レイアウトに、さらに遠近感（パース）を意識した配置や方向や寸法を視認できる状態までデッサンするための記号。|遠近感<br>画面レイアウト<br>位置<br>向き|立方体<br>デッサン人形<br>棒人間|
|流線型素体|方向や寸法が定まってパースにのった被写体の表面に、任意の線を描いて立体感をスキャンするための記号。|立体感<br>輪郭線の前後関係<br>表面の凹凸<br>素材の付着点|競泳水着ライン<br>断面|
|素材|遠近感と立体感が定まった被写体に、デザインを決定するパーツを組み込んでいくための記号。|大まかなシルエット<br>パーツ形状<br>目の大きさや位置|黄金比|
|印象|遠近感・立体感・デザインの3点セットが揃った被写体の、見た目が狙い通りになるよう描き込みや微調整を行うための記号。印象の記号は鑑賞者が真っ先に認識する部分なので、作品の個性に影響する記号でもある。|作風・画風<br>情報量のコントロール|瞳やまぶたの描き方<br>髪の束や服のシワの線の数|
|添削|一度完成した絵の違和感に違和感があるとき、位置や寸法を測定して原因を発見するための記号。既に描き込まれた絵の上に重ねる記号なので情報量は最小限に抑える。|位置の確認<br>線の方向や角度の測定<br>|正中線<br>コントラポスト|
...
集中サイクルは、意図的に作業するため、失敗を未然に防ぐため、最大限の能力を発揮するため、精神的な障壁を取り除くため、といった描画技術の補助という目的が強いことがわかります。
